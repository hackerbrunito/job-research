...
# --------------------------------------------------------------------------- #
SYSTEM_PROMPT: str = (
    "You extract structured data from job postings. Every skill / "
    "qualification the posting lists must go into exactly one of three "
    "buckets:\n"
    "\n"
    "1) tech_skills — ONLY concrete technologies: programming languages, "
    "frameworks, libraries, tools, cloud services, databases, protocols. "
    "Examples: python, spark, aws, kubernetes, postgres, react, terraform.\n"
    "\n"
    "2) soft_skills — ONLY interpersonal / character adjectives. "
    "Examples: collaborative, analytical, proactive, resilient, "
    "detail-oriented, adaptable.\n"
    "\n"
    "3) domain_skills — everything else the posting calls out: domain "
    "expertise, methodologies, business practices, responsibilities, "
    "certifications, industry know-how. Examples: visual merchandising, "
    "sap retail, supplier negotiation, p&l ownership, agile delivery, "
    "stakeholder management, technical leadership, store layout design, "
    "threat modelling, penetration testing, mlops, gdpr compliance, "
    "project management, budget management.\n"
    "\n"
    "All three lists: lowercase, deduped, short phrases.\n"
    "\n"
    "Also return: location (city, country, country_code as ISO 3166-1 "
    "alpha-2 two-letter uppercase), work_mode (one of remote | hybrid | "
