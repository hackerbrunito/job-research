...
-- DataFrame columns: job_id, run_id, scraped_at, enriched_at, site,
-- search_keyword, company, title, job_url, date_posted, work_mode,
-- location_key, salary_key.
INSERT INTO fact_job_offers (
    job_id, run_id, scraped_at, enriched_at, site, search_keyword,
