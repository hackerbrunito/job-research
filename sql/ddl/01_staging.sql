...
CREATE TABLE IF NOT EXISTS staging_job_offers (
    ...
    profile_id       VARCHAR,                       -- search profile that triggered this scrape
...
ALTER TABLE staging_job_offers ADD COLUMN IF NOT EXISTS profile_id VARCHAR;
CREATE INDEX IF NOT EXISTS idx_staging_profile ON staging_job_offers(profile_id);
